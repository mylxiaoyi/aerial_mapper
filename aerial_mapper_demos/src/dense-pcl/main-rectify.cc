...
int main(int argc, char** argv) {
  ...
  Images images;
  io_handler.loadImagesFromFile(filename_images, num_poses, &images, true);
  ...
  stereo::MyStereo stereo(ncameras, settings_dense_pcl, block_matching_params);
